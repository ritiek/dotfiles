{
    ...
    "buttons": {
        ...
        "LB": {
            ...
            "name": "Gloves Punch Grab Spam"
        }, 
        "LGRIP": {
            "action": "button(Keys.BTN_GAMEPAD)"
        }, 
        "RB": {
            "action": "repeat(button(Keys.BTN_NORTH); sleep(0.020); button(Keys.BTN_WEST); sleep(0.365); button(Keys.BTN_WEST); sleep(0.020))", 
            "name": "Punch Grab Spam"
        }, 
        "RGRIP": {
    ...
    "rstick": {}, 
    "stick": {
        "action": "XY(axis(Axes.ABS_X), raxis(Axes.ABS_Y)) and ring()"
    }, 
    "trigger_left": {
